  ...
  return (
    <div className=" flex flex-col items-center justify-center min-w-96 mx-auto">
      ...
      <h1 className="text-3xl font-semibold text-center text-gray-300">Sign
        <span className="text-green-900">Up</span></h1>
        <form>
        <div>
            <label className="label p-2">
                <span className="text-base label-text">Full Name</span>
            </label>
            <input type="text" placeholder="Nguyen Van A" className="w-full input input-bordered h-10" />
        </div>
        <div>
        <label className="label p-2">
        ...
        <div>
            <button className="btn btn-block btn-neutral btn-sm mt-2 border border-slate-700">Sign Up</button>
        </div>
        </form>
      </div>
    </div>
